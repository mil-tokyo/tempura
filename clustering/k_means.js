(function() {
    ...
    AgentSmithML = {};
    AgentSmithML.Kmeans = function(n_clusters) {
    ...
    AgentSmithML.Kmeans.prototype.fit = function(){
	...
	var init_mats = init_clusters(this.n_clusters, samples);
	...
	for(var i=0; i<n_samples; i++){
	    ...
	    sample = get_row(samples, sample_ind);
...
//	var init_sample_ind = _.sample(_.range(n_samples), n_clusters);
    ...
    var kmeans = new AgentSmithML.Kmeans(2);
    kmeans.fit();
